...
contract ForkSanityTest is ForkBase {
    ...
    function test_uniswapV3IsLive() public view {
        ...
        assertEq(INonfungiblePositionManager(V3_POSITION_MANAGER).factory(), V3_FACTORY, "NPM factory mismatch");
    }

    function test_uniswapV4IsLive() public view {
        assertGt(V4_POOL_MANAGER.code.length, 0, "no code at PoolManager");
        assertEq(IPositionManagerV4(V4_POSITION_MANAGER).poolManager(), V4_POOL_MANAGER, "posm/pm mismatch");
    }
    ...
    function test_parkingVenuesResolveAndAreLiquid() public view {
        ...
        assertEq(IUniswapV3Factory(V3_FACTORY).getPool(CBBTC, USDC, 500), POOL_CBBTC_USDC_500, "cbBTC/USDC");
    ...
    function test_v3OracleIsUsableOnBothVenues() public view {
        ...
        (int56[] memory cumulativesVolatile,) = IUniswapV3Pool(POOL_CBBTC_USDC_500).observe(secondsAgos);
